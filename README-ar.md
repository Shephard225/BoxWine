...
- **المعالج SoC:** Qualcomm Snapdragon 655 أو ما يعادله
- **المعمارية:** ARM64 (AArch64)
- **الذاكرة RAM:** حد أدنى 3GB (يوصى بـ 4GB أو أكثر)
- **النظام:** Android 10 أو أحدث
- **GPU:** Adreno مع دعم Vulkan (موصى به)
- **التخزين:** مساحة فارغة 6–8GB
...
- Termux-X11  
https://raw.githubusercontent.com/olegos2/mobox/main/components/termux-x11.apk

- Input Bridge  
https://raw.githubusercontent.com/olegos2/mobox/main/components/inputbridge.apk
...
BoxWine مشروع **غير رسمي** وغير مرتبط بمطوري WineHQ أو Box64 أو Box86 أو Termux.
